...
export default function MusicPlayer({ className = "" }: MusicPlayerProps) {
  ...
  const [volumeControlVisible, setVolumeControlVisible] = useState(false); // Track if volume control is visible
        ...
        <div className="flex items-center justify-end space-x-3 w-1/3">
          ...
          <div className="flex items-center space-x-1 relative">
            ...
            {volumeControlVisible && (
              <div className="absolute right-0 bottom-full mb-2 bg-[#1a1a3a] p-2 rounded-md shadow-lg z-50">
                <input
                  type="range"
                  min="0"
                  max="1"
