    ...
    >
      ...
      <motion.div
        className={`w-full h-full absolute inset-0 cursor-pointer ${
          isActive ? "hover:bg-white/5" : "pointer-events-none"
        } ${
          isTargetLane ? "bg-primary/10" : ""
        }`}
        whileHover={isActive ? { backgroundColor: isTargetLane ? "rgba(79, 70, 229, 0.2)" : "rgba(255, 255, 255, 0.05)" } : {}}
        whileTap={isActive ? { backgroundColor: isTargetLane ? "rgba(79, 70, 229, 0.3)" : "rgba(255, 255, 255, 0.1)" } : {}}
