    ...
    <div className="p-4 bg-gray-800 text-white rounded-lg shadow-lg max-w-4xl mx-auto my-8">
      ...
      {queryResult && (
        <div className="mb-4">
          ...
          <pre className="p-4 bg-gray-700 rounded overflow-auto max-h-96 whitespace-pre-wrap">
      ...
      <div className="mt-8 p-4 bg-gray-700 rounded">
        ...
        <p>RPC URL: Using MetaMask provider (Abstract testnet)</p>
        
        <div className="mt-4">
          <h4 className="font-bold">Abstract Testnet Info:</h4>
          <p>Chain ID: 11124</p>
